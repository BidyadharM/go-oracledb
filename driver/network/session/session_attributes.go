...
func (sa *SessionAtts) Prepare(protocol common.Protocol) error {
	...
	sa.NT.UseSystemTrust = protocol == common.ProtocolTCPS &&
		(walletLocation == "" || strings.EqualFold(walletLocation, systemWalletLocation))
	if protocol == common.ProtocolTCPS && sa.NT.WalletContent == nil && !sa.NT.UseSystemTrust {
