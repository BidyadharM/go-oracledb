...
func (c *ClobExecutor) Write(
	...
	lobAmt := common.UB8(0)
	if sendLobAmt {
		lobAmt = common.UB8(count)
	}

	writeBuffer := common.B1Array(binaryWriteBuffer[:bytesConverted])
...
func (c *ClobExecutor) Read(
	...
	binaryReadBuffer := make(common.B1Array, bufferSize)
	...
	return common.UB8(decodedChars), nil
}
