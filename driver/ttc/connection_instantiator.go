...
func (connInstantiator *connectionInstantiator) GetConnection(ctx context.Context) (driver.Conn, error) {
	if connInstantiator.localizationService == nil {
		return nil, common.NewOracleError(common.MissingLocalizationService, nil)
	}
...
func GetAuthenticator(parameters *common.OracleDriverConfig) (Authenticator, error) {
	...
	return nil, common.NewOracleError(common.NoAuthenticatorError, nil, nil)
}

func createPasswordAuthenticator(parameters *common.OracleDriverConfig) (Authenticator, error) {
...
func GetNegotiator(transport common.DataBuffer) Negotiator {
