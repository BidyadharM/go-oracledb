...
func (c *Connection) BeginTx(ctx context.Context, opts driver.TxOptions) (driver.Tx, error) {
	...
	if c.shelf.isInTransaction() {
		return nil, c.shelf.LocalizeError(common.NewOracleError(common.AlreadyInTransaction, nil, nil))
	}
	...
	default:
		return nil, c.shelf.LocalizeError(common.NewOracleError(common.IsolationLevelNotSupported, nil, nil))
	}
	...
	if isolationLevelStmt != "" {
		...
		if err != nil {
			...
			return nil, common.NewOracleError(common.ConfigureTransactionError, err, nil)
		}
	}
