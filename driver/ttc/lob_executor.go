...
func (e *lobExecutor) SetShelf(shelf *common.Shelf[common.MessageType]) {
	e.shelf = shelf
}
...
func (e *lobExecutor) read(ctx context.Context, lobLocator *locator, numBytes common.UB8, outBuffer common.B1Array) (common.UB8, error) {
	...
	if err := e.executeRead(ctx, def, outBuffer); err != nil {
		...
		return 0, common.NewOracleError(common.LobExecError, err, "read")
	}
...
func (e *lobExecutor) write(ctx context.Context, lobLocator *locator, inBuffer common.B1Array,
	numBytes common.UB8) (common.UB8, error) {
	...
	if err := e.executeWrite(ctx, def, inBuffer); err != nil {
		...
		return 0, common.NewOracleError(common.LobExecError, err, "write")
	}
...
func (e *lobExecutor) GetLength(ctx context.Context, lobLocator *locator) (common.UB8, error) {
	...
	if err := e.execute(ctx, def); err != nil {
		...
		return 0, common.NewOracleError(common.LobExecError, err, "get-length")
	}
...
func (e *lobExecutor) GetChunkSize(ctx context.Context, lobLocator *locator) (common.UB8, error) {
	...
	if err := e.execute(ctx, def); err != nil {
		...
		return 0, common.NewOracleError(common.LobExecError, err, "get-chunk-size")
	}
...
func (e *lobExecutor) Trim(ctx context.Context, lobLocator *locator, newLength common.UB8) (common.UB8, error) {
	...
	if err := e.execute(ctx, def); err != nil {
		...
		return 0, common.NewOracleError(common.LobExecError, err, "trim")
	}
...
func (e *lobExecutor) open(ctx context.Context, lobLocator *locator, mode LobOpenMode) (bool, error) {
	...
	if lobLocator.isTemporaryLocator() || lobLocator.isAbstractLocator() {
		...
		if lobLocator.isOpenLocator() {
			err := common.NewOracleError(common.LobOpen, nil)
	...
	if err := e.execute(ctx, def); err != nil {
		...
		return didOpen, common.NewOracleError(common.LobExecError, err, "open")
	}
...
func (e *lobExecutor) close(ctx context.Context, lobLocator *locator) error {
	...
	if lobLocator.isTemporaryLocator() || lobLocator.isAbstractLocator() {
		...
		if !lobLocator.isOpenLocator() {
			err := common.NewOracleError(common.LobClosed, nil)
	...
	if err := e.execute(ctx, def); err != nil {
		...
		return common.NewOracleError(common.LobExecError, err, "close")
	}
...
func (e *lobExecutor) IsOpen(ctx context.Context, lobLocator *locator) (bool, error) {
	...
	if err := e.execute(ctx, def); err != nil {
		...
		return false, common.NewOracleError(common.LobExecError, err, "is-open")
	}
...
func validateLobOperation(lobLocator *locator, operation lobOperationCode) error {
	...
	if !operation.IsValid() {
		err := common.NewOracleError(common.InvalidLOBBuffer, nil, operationName, "lob", "unsupported operation")
	...
	if lobLocator.isValueBasedLocator() {
		err := common.NewOracleError(common.InvalidLOBBuffer, nil, operationName, "lob", "value-based locator not supported")
		common.Odl.Error("validateLobOperation: value-based locator", "operation", operation, "error", err)
		return err
	}

	if lobLocator.isReadOnlyLocator() {
		err := common.NewOracleError(common.InvalidLOBBuffer, nil, operationName, "lob", "locator is read-only")
...
func (e *lobExecutor) execute(ctx context.Context, lobDefinition *lobDefinition) error {
	...
	if err := stmr.Flush(ctx); err != nil {
		...
		return common.NewOracleError(common.LobExecError, err, "flush")
	}
...
// or failure.
func (e *lobExecutor) executeRead(ctx context.Context, lobDefinition *lobDefinition, buffer common.B1Array) error {
...
func (e *lobExecutor) executeWrite(ctx context.Context, lobDefinition *lobDefinition, buffer common.B1Array) error {
...
func (e *lobExecutor) _registerLobdCallback(buffer common.B1Array) error {
	stmr, _ := e.shelf.GetMessageStreamer().(MessageStreamerInterface)
	stmr.RegisterPreUnmarshallCallback(TTILOBD, func(*messageHeader) (common.Message[common.MessageType], error) {
		...
		if err != nil {
			...
			return nil, common.NewOracleError(common.CallbackFactoryError, err, "registerLobdCallback failed")
		}
		lobd, _ := msg.(*tTIlobd)
	...
	stmr.RegisterPostUnmarshallCallback(TTILOBD, func(msg common.Message[common.MessageType], prevErr error) (bool, error) {
		lobd, _ := msg.(*tTIlobd)
		if prevErr != nil {
...
func (e *lobExecutor) _registerLobRPACallback(def *lobDefinition) {
	stmr, _ := e.shelf.GetMessageStreamer().(MessageStreamerInterface)
	stmr.RegisterPreUnmarshallCallback(TTIRPA, func(*messageHeader) (common.Message[common.MessageType], error) {
		...
		if err != nil {
			...
			return nil, common.NewOracleError(common.CallbackFactoryError, err, "registerLobRpaCallback failed")
		}
...
func (e *lobExecutor) _pushLobRequest(ctx context.Context, def *lobDefinition) error {
	...
	if err := stmr.Push(ctx, msg); err != nil {
		...
		return common.NewOracleError(common.LobExecError, err, "push")
	}
	return nil
}

// _pushWritePayload sends the TTILOBD payload.
func (e *lobExecutor) _pushWritePayload(ctx context.Context, buffer common.B1Array) error {
	stmr, _ := e.shelf.GetMessageStreamer().(MessageStreamerInterface)
...
func (e *lobExecutor) _consumeLobResponses(ctx context.Context) error {
	...
	for {
		...
		if err != nil {
			...
			return common.NewOracleError(common.LobExecError, err, "pull")
		}
