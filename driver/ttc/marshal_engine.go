...
type unmarshalTypes interface {
	common.UB1 | common.UB2 | common.UB4 | common.UB8 | common.SB1 | common.SB2 | common.SB4
}
...
var (
	...
	_nullPTR           = common.B1Array{0x00, 0x00, 0x00, 0x00}
	_notNullPTR        = common.B1Array{0x7F, 0x7F, 0x7F, 0x7F}
)
...
func NewNativeMarshalEngine(dataBuffer common.DataBuffer, byteOrder session.ByteOrder) *MarshalEngine {
...
// Returns:
//   - A pointer to a new MarshalEngine instance.
func NewMarshalEngine(dataBuffer common.DataBuffer, byteOrder session.ByteOrder, types [5]byte) *MarshalEngine {
	engine := MarshalEngine{
...
func (m *MarshalEngine) marshalSeqNo(ctx context.Context) (common.UB1, error) {
	if m._sequenceNumber <= 0 {
		// max int8 value has rotated the counter
		// put it back to 1
		m._sequenceNumber = 1
	}
	err := m.MarshalUB1(ctx, common.UB1(m._sequenceNumber))
	ret := m._sequenceNumber
	m._sequenceNumber++
	return common.UB1(ret), err
}
...
//   - An error if marshaling fails.
func (m *MarshalEngine) marshalTokenNo(ctx context.Context) (common.UB1, error) {
...
func (m *MarshalEngine) MarshalUB1(ctx context.Context, value common.UB1) error {
...
// Returns:
//   - An error if the marshaling operation fails.
func (m *MarshalEngine) MarshalUB2(ctx context.Context, value common.UB2) error {
	if m._numericTypeRep[UB2Index].typeRep != Universal {
		return _writeNative(ctx, value, m, m._numericTypeRep[UB2Index],
			func(byteArray []byte, value common.UB2) {
...
// Returns:
//   - An error if the marshaling operation fails.
func (m *MarshalEngine) MarshalUB4(ctx context.Context, value common.UB4) error {
	if m._numericTypeRep[UB4Index].typeRep != Universal {
		return _writeNative(ctx, value, m, m._numericTypeRep[UB4Index],
			func(byteArray []byte, value common.UB4) {
...
// Returns:
//   - An error if the marshaling operation fails.
func (m *MarshalEngine) MarshalUB8(ctx context.Context, value common.UB8) error {
	if m._numericTypeRep[UB8Index].typeRep != Universal {
		return _writeNative(ctx, value, m, m._numericTypeRep[UB8Index],
			func(byteArray []byte, value common.UB8) {
...
// Returns:
//   - An error if the marshaling operation fails.
func (m *MarshalEngine) MarshalSB4(ctx context.Context, value common.SB4) error {
	if m._numericTypeRep[SB4Index].typeRep != Universal {
		return _writeNative(ctx, value, m, m._numericTypeRep[SB4Index],
			func(byteArray []byte, value common.SB4) {
				binary.LittleEndian.PutUint32(byteArray, uint32(value))
			},
			func(byteArray []byte, value common.SB4) {
				binary.BigEndian.PutUint32(byteArray, uint32(value))
...
// Returns:
//   - An error if the marshaling operation fails.
func (m *MarshalEngine) MarshalB1Array(ctx context.Context, value common.B1Array) error {
...
// Returns:
//   - An error if the marshaling operation fails.
func (m *MarshalEngine) MarshalChar(ctx context.Context, value common.B1Array) error {
	if len(value) > 0 {
...
// Returns:
//   - An error if the marshaling operation fails.
func (m *MarshalEngine) MarshalCLR(ctx context.Context, value common.B1Array, offset, totalLength int) error {
	if totalLength > int(_maximumShortValueLength) {
		...
		for nbBytesWritten < totalLength {
			...
			if err := m.MarshalSB4(ctx, common.SB4(length)); err != nil {
				return _wrapError(err, "CLR")
			}
...
func (m *MarshalEngine) UnmarshalUB1(ctx context.Context) (common.UB1, error) {
	value, err := m._dataBuffer.ReadByteWithContext(ctx)
	return common.UB1(value), _wrapError(err, m._numericTypeRep[UB1Index].typeName)
}
...
// Parameters:
//   - ctx: The request context used for buffer reads.
func (m *MarshalEngine) UnmarshalUB2(ctx context.Context) (common.UB2, error) {
	return _unmarshalNumeric(ctx, m, m._numericTypeRep[UB2Index],
		func(b []byte) common.UB2 {
			return common.UB2(binary.BigEndian.Uint16(b))
		},
		func(b []byte) common.UB2 {
			return common.UB2(binary.LittleEndian.Uint16(b))
		},
		func(value common.UB2) common.UB2 {
			return value
		})
}
...
// Parameters:
//   - ctx: The request context used for buffer reads.
func (m *MarshalEngine) UnmarshalUB4(ctx context.Context) (common.UB4, error) {
	return _unmarshalNumeric(ctx, m, m._numericTypeRep[UB4Index],
		func(b []byte) common.UB4 {
			return common.UB4(binary.BigEndian.Uint32(b))
		},
		func(b []byte) common.UB4 {
			return common.UB4(binary.LittleEndian.Uint32(b))
		},
		func(value common.UB4) common.UB4 {
			return value
		})
}
...
// Parameters:
//   - ctx: The request context used for buffer reads.
func (m *MarshalEngine) UnmarshalUB8(ctx context.Context) (common.UB8, error) {
	return _unmarshalNumeric(ctx, m, m._numericTypeRep[UB8Index],
		func(b []byte) common.UB8 {
			return common.UB8(binary.BigEndian.Uint64(b))
		},
		func(b []byte) common.UB8 {
			return common.UB8(binary.LittleEndian.Uint64(b))
		},
		func(value common.UB8) common.UB8 {
			return value
		})
}
...
// Parameters:
//   - ctx: The request context used for buffer reads.
func (m *MarshalEngine) UnmarshalSB1(ctx context.Context) (common.SB1, error) {
	value, err := m.UnmarshalSB2(ctx)
	if err != nil {
		return 0, _wrapError(err, m._numericTypeRep[SB1Index].typeName)
	}
	return common.SB1(value), nil
}
...
// Parameters:
//   - ctx: The request context used for buffer reads.
func (m *MarshalEngine) UnmarshalSB2(ctx context.Context) (common.SB2, error) {
	return _unmarshalNumeric(ctx, m, m._numericTypeRep[SB2Index],
		...
		func(value common.UB2) common.SB2 {
			return common.SB2(-1) * common.SB2(value)
		})
}
...
// Parameters:
//   - ctx: The request context used for buffer reads.
func (m *MarshalEngine) UnmarshalSB4(ctx context.Context) (common.SB4, error) {
	return _unmarshalNumeric(ctx, m, m._numericTypeRep[SB4Index],
		...
		func(value common.UB4) common.SB4 {
			return common.SB4(-1) * common.SB4(value)
		})
}
...
//   - An error if the unmarshaling operation fails.
func (m *MarshalEngine) UnmarshalB1Array(ctx context.Context, length int) (common.B1Array, error) {
...
//   - A pointer to the unmarshaled B1Array.
//   - An error if the unmarshaling operation fails.
func (m *MarshalEngine) UnmarshalText(ctx context.Context, length int) (common.B1Array, error) {
	offset := 0
...
//   - An error if the unmarshaling operation fails.
func (m *MarshalEngine) UnmarshalCLR(ctx context.Context, bytes common.B1Array, maxSize int) (int, error) {
	...
	if byte(lenflag) == _espapeValue {
		return 0, _wrapError(common.NewOracleError(common.ProtocolViolation, nil, nil), "CLR")
	}
	...
	for {
		...
		if length < 0 {
			...
			return -1, common.NewOracleError(common.MarshalEngineError, nil, "CLR")
		}
...
// Parameters:
//   - ctx: The request context used for buffer reads.
func (m *MarshalEngine) UnmarshalCLRColumnData(ctx context.Context) (common.B1Array, int, error) {
	...
	if byte(lenflag) == _espapeValue {
		return nil, 0, _wrapError(common.NewOracleError(common.ProtocolViolation, nil, nil), "CLR")
	}
	if byte(lenflag) == _nullLengthIndicator {
		return nil, 0, nil
	}
	...
	if byte(lenflag) <= _maximumShortValueLength { // Smaller than MAX length
		bytes := make(common.B1Array, lenflag)
		err := m._unmarshalBuffer(ctx, bytes, 0, int(lenflag))
		return bytes, int(lenflag), _wrapError(err, "CLR")
	}
	// Got FE marker, long chunks
	nbBytesWritten := 0
	var bytes common.B1Array
	for {
		length, err := m.UnmarshalSB4(ctx)
		if err != nil {
			return nil, 0, _wrapError(err, "CLR")
		...
		if length < 0 {
			common.Odl.Debug("Invalid length value while unmarshalling CLR", "length", length)
			return nil, -1, _wrapError(common.NewOracleError(common.ProtocolViolation, nil), "CLR")
		}
		...
		currentBytes := make(common.B1Array, length)
...
func (m *MarshalEngine) Flush(ctx context.Context) error {
	...
	if err != nil {
		return common.NewOracleError(common.MarshalEngineFlushError, err)
	}
	return nil
}
...
func (m *MarshalEngine) _unmarshalBuffer(ctx context.Context, byteValue []byte, offset int, length int) error {
	...
	if len(byteValue) < offset+length {
		common.Odl.Debug("Invalid buffer length", "buffer length", len(byteValue),
			"data length", length)
		return common.NewOracleError(common.MarshalEngineError, nil, "CLR")
	}
...
func _writeUniversal(ctx context.Context, absoluteValue uint64, isNegative bool, dataBuffer common.DataBuffer) error {
	if absoluteValue == 0 {
		buffer := make([]byte, 1)
		buffer[0] = 0
...
func _decodeUniversal[T unmarshalTypes, V unmarshalTypes](
	...
	if negativeUNV && typeRep.isUnsigned {
		...
		return zero, common.NewOracleError(common.MarshalEngineError, nil, typeRep.typeName)
	}
...
func _validateUniversalByteCount(firstByte byte, numberOfBytes byte, maxBytes uint8, typeName string) error {
	...
	if numberOfBytes == 0 {
		...
		return common.NewOracleError(common.MarshalEngineError, nil, typeName)
	}
...
func _readNative[T unmarshalTypes, V unmarshalTypes](ctx context.Context, dataBuffer common.DataBuffer, byteOrder session.ByteOrder, typeName string, maxBytes uint8,
...
func _wrapError(err error, dataType string) error {
	if err != nil {
		err = common.NewOracleError(common.MarshalEngineError, err, dataType)
	}
	return err
}
