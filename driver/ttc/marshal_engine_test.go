...
func TestFlush(t *testing.T) {
	...
	if sqlError, ok := err.(common.SQLError); ok {
		if sqlError.ErrorCode() != string(common.MarshalEngineFlushError) {
			t.Fatalf("Wrong error code, should be %s but was %s", common.MarshalEngineFlushError, sqlError.ErrorCode())
		}
	} else {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			if test.wantErr {
				...
				checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), "SB2")
				return
			}
			if err != nil {
				t.Fatalf("UnmarshalSB2 failed: %v", err)
...
func TestUnmarshalUnsignedUniversalRejectsNegativeFlag(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), test.name)
		})
	}
}
...
func TestUnmarshalCLRColumnDataRejectsInvalidLongChunkLengths(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), "CLR")
		})
	}
}
...
func TestMarshalUB1NoSpace(t *testing.T) {
	...
	for i := 0; i < 256; i++ {
		...
		checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), "UB1")
	}
}
...
func TestMarshalCLRNoSpace(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if sqlError, ok := err.(common.SQLError); ok {
				if sqlError.ErrorCode() != string(common.MarshalEngineError) {
					t.Fatalf("Wrong error code, should be %s but was %s", common.MarshalEngineError, sqlError.ErrorCode())
				}
...
func TestUnmarshalUB2NoSpace(t *testing.T) {
	...
	checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), "UB2")
...
func TestUnmarshalUB4NoSpace(t *testing.T) {
	...
	checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), "UB4")
...
func TestUnmarshalUniversalRejectsByteCountsOverTargetWidth(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), test.errType)
		})
	}
}
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			if test.wantErr {
				...
				checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), "SB4")
				return
			}
			if err != nil {
...
func TestDynamicAllocatedArrayRejectsNegativeUniversalLength(t *testing.T) {
	...
	checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), "unmarshal value")
}
...
func TestUnmarshalUB1ArrayNoSpace(t *testing.T) {
	...
	checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), "B1Array")
}
...
func TestUnmarshalTextNoSpace(t *testing.T) {
	...
	checkSQLErrorCodeContains(t, err, string(common.MarshalEngineError), "Text")
}
