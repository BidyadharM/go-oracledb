...
func (mh *messageHeader) UnMarshalFrom(ctx context.Context, engine common.Marshaller) error {
...
func (mh *messageHeader) MarshalTo(ctx context.Context, engine common.Marshaller) error {
	if err := engine.MarshalUB1(ctx, common.UB1(mh.messageType)); err != nil {
		return err
	}
	return nil
}

func (mh *messageHeader) GetType() common.MessageType {
