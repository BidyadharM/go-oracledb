...
func init() {
	...
	if err := BindOacRegistry.Register(reflect.TypeOf(refcursor.RefCursor{}), MinTTCProtocolVersion, bindOacType{bindOacFunc: func(common.UB4) common.Marshallable { return newTTIoac(common.DtyRSet, 4) }, maxLength: 4}); err != nil {
