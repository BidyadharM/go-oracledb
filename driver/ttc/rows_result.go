...
type LobColumnContext struct {
	...
	LobLength         common.UB4
	PrefetchLength    common.UB8
	PrefetchChunkSize common.UB4
	LobLocator        common.B1Array
}
...
func (r *ttcRows) SetShelf(shelf *ttiShelf[common.MessageType]) {
	r.shelf = shelf
	r.strictNullHandlingValue = true
	if r.shelf.Shelf.GetConnectionProperties() != nil {
		r.strictNullHandlingValue = r.shelf.Shelf.GetConnectionProperties().StrictNullValueHandling
	}
}
...
func (r *ttcRows) Columns() []string {
	...
	for i, colCtx := range r.columnContexts {
		res[i] = common.B1ArrayToString(colCtx.Name)
	}
...
var defaultNullValueResolvers = map[DtyType]defaultNullValueResolver{
	...
	DtyBin:      constantDefaultNullValue(common.B1Array{}),
	DtyVbi:      constantDefaultNullValue(common.B1Array{}),
	DtyLbi:      constantDefaultNullValue(common.B1Array{}),
	DtyBlob:     constantDefaultNullValue(common.B1Array{}),
	DtyDblob:    constantDefaultNullValue(common.B1Array{}),
...
func (r *ttcResult) LastInsertId() (int64, error) {
	return 0, r.shelf.LocalizeError(common.NewOracleError(common.UnsupportedFeature, nil, "LastInsertId"))
}
