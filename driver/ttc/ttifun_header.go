...
func newLogOff() common.Message[common.MessageType] {
	return &ttiFunHeader{
		_funcType: logOff,
	}
}
...
func newLogOff18() common.Message[common.MessageType] {
...
func newPing() common.Message[common.MessageType] {
	return &ttiFunHeader{
		_funcType: ping,
	}
}
...
func newPing18() common.Message[common.MessageType] {
	return &ttiFunHeader18{
...
func newCommit() common.Message[common.MessageType] {
	return &ttiFunHeader{
		_funcType: commit,
	}
}
...
func newCommit18() common.Message[common.MessageType] {
	return &ttiFunHeader18{
...
func newRollback() common.Message[common.MessageType] {
	return &ttiFunHeader{
		_funcType: rollback,
	}
}
...
func newRollback18() common.Message[common.MessageType] {
	return &ttiFunHeader18{
...
func (msg *ttiFunHeader) GetMsgCode() common.MessageType {
	return TTIFUN
}
...
// marshalled.
func (msg *ttiFunHeader) MarshalTo(ctx context.Context, engine common.Marshaller) error {
	err := engine.MarshalUB1(ctx, common.UB1(msg._funcType))
	if err != nil {
		common.Odl.Debug("Error marshalling function type for function with no data of type",
			"function type", msg._funcType, "error", err)
		return common.NewOracleError(common.FailMarshal, err)
	}
...
// Note that this message does not have any payload, only the message code is
// marshalled.
func (msg *ttiFunHeader18) MarshalTo(ctx context.Context, engine common.Marshaller) error {
