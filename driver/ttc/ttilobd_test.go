...
func TestTTILobd_UnMarshalFrom_Fail(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantCode:   string(common.FailUnmarshal),
...
func TestTTILobd_MarshalTo_Fail(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			wantCode:   string(common.FailMarshal),
			wantErrMsg: "CLR",
		},
	}
...
// requireSQLError converts a generic error into a common.SQLError for assertions
// and fails the test immediately when the conversion is not possible.
func requireSQLError(t *testing.T, err error) common.SQLError {
	t.Helper()
	sqErr, ok := err.(common.SQLError)
	if !ok {
