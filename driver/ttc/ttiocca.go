...
type tTIOcca struct {
	...
	cursorIDs        []common.UB4 // array of cursorId IDs
}

// newOcca18 creates a new instance of OCCA message with sequence number and token.
func newOcca18() common.Message[common.MessageType] {
	return &tTIOcca{
...
func newOcca() common.Message[common.MessageType] {
	return &tTIOcca{
...
func (m *tTIOcca) GetMsgCode() common.MessageType { return TTIPFN }

// GetFuncCode returns the TTC function code associated with OCCA.
func (m *tTIOcca) GetFuncCode() common.FunctionType { return occa }

// setCursorIDs sets the cursorId ids to be closed or canceled.
func (m *tTIOcca) setCursorIDs(ids []common.UB4) { m.cursorIDs = ids }

// MarshalTo serializes the OCCA function message.
func (m *tTIOcca) MarshalTo(ctx context.Context, engine common.Marshaller) error {
	...
	offset := common.UB4(len(m.cursorIDs))
