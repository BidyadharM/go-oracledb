...
type tTIoer struct {
	curRowNumber               common.UB4 // curRowNumber is the number of rows processed.
	retCode                    common.UB2 // retCode is the error code (if any) returned by the server.
	arrayElemWError            common.UB2
	arrayElemErrno             common.UB2
	currCursorID               common.UB2
	errorPosition              common.UB2
	sqlType                    common.UB1
	oerFatal                   common.UB2
	flags                      common.UB2
	userCursorOpt              common.UB2
	upiParam                   common.UB1
	warningFlag                common.UB1
	osError                    common.UB4
	stmtNumber                 common.UB1
	callNumber                 common.UB1
	pad1                       common.UB2
	successIters               common.UB4
	partitionID                common.UB2 // partitionID is rowid
	tableID                    common.UB1
	slotNumber                 common.UB2
	rba                        common.UB4
	blockNumber                common.UB4
	warnLength                 common.UB2
	warnFlag                   common.UB2
	endToEndECIDSequenceNumber common.UB2
	oercn2                     common.UB8 // Number of rows processed
	oerrcd2                    common.UB4 // Error code
...
func NewTTIoer() common.Message[common.MessageType] {
	return &tTIoer{
...
func NewTTIoerWithEndOfCallStatusSupport() common.Message[common.MessageType] {
	return &tTIoer{
...
func (o *tTIoer) GetMsgCode() common.MessageType {
	return TTIOER
}
...
func (o *tTIoer) UnMarshalFrom(ctx context.Context, mar common.Marshaller) error {
...
func (o *tTIoer) _unmarshalErrorMessage(ctx context.Context, mar common.Marshaller) error {
	b := make(common.B1Array, errorMessageMaxLength)
	...
	if err != nil {
		...
		return common.NewOracleError(common.FailUnmarshal, err, TTCMsgTypeDescription[o.GetMsgCode()])
	}
	o.errorMsg = b[:n]
	o.errorLength[0] = n
...
func (o *tTIoer) _unmarshalAttributes(ctx context.Context, mar common.Marshaller) error {
	var err error
...
func (o *tTIoer) _unmarshalWarning(ctx context.Context, mar common.Marshaller) error {
	var err error
...
func unmarshalEndOfCallStatus(ctx context.Context, mar common.Marshaller) (*endOfCallStatus, error) {
	var ucaeocs common.UB4
	var err error
	...
	if ucaeocs, err = mar.UnmarshalUB4(ctx); err != nil {
		...
		return nil, common.NewOracleError(common.FailUnmarshal, err, "EndOfCallStatus")
	}

	if (ucaeocs & TtiEocEct) != 0 {
		var elapsedTime common.UB8
...
func (o *tTIoer) GetCurRowNumber() common.UB8 {
	return o.oercn2
}

// GetRetCode returns the error code (oerrcd2).
func (o *tTIoer) GetRetCode() common.UB4 {
	return o.oerrcd2
}
