...
type tTIoer14 struct {
	*tTIoer
	sqlCommandType common.UB4 // SQL command type
	checksum       common.UB4
}

// NewTTIoer14 creates a new instance of tTIoer.
func NewTTIoer14() common.Message[common.MessageType] {
	return &tTIoer14{
...
func NewTTIoer14WithEndOfCallStatusSupport() common.Message[common.MessageType] {
	return &tTIoer14{
...
func (t *tTIoer14) UnMarshalFrom(ctx context.Context, mar common.Marshaller) error {
...
func (t *tTIoer14) _unmarshalAttributes(ctx context.Context, mar common.Marshaller) error {
	...
	if t.sqlCommandType, err = mar.UnmarshalUB4(ctx); err != nil {
		...
		return common.NewOracleError(common.FailUnmarshal, err, TTCMsgTypeDescription[t.GetMsgCode()])
	}
