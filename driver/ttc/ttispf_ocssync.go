...
func (spf *ttiSPFOCSSync) UnMarshalFrom(ctx context.Context, engine common.Marshaller) error {
	...
	if err != nil {
		...
		return common.NewOracleError(common.FailUnmarshal, err, "session sync")
	}
	// Flags (ignored)
...
func (spf *ttiSPFOCSSync) getKeyValueArr() *common.Properties[string] {
	props := common.NewProperties[string]()
