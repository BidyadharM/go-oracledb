...
type decoderFunc func(ColumnContext, common.B1Array) (driver.Value, error)
...
type defineOacFunc func(ColumnContext, common.UB4) common.Marshallable
...
*/
func (f *CodecFactoryImpl) GetBindOac(normalized normalizedBindValue, maxLength common.UB4) (common.Marshallable, error) {
...
func (f *CodecFactoryImpl) GetDefineOac(
	...
	bestCandidate := getEntryFromRegistry(f.ttcVersion, candidates)
	var lobPrefetchSize common.UB4
	if connectionProperties != nil {
		lobPrefetchSize = common.UB4(connectionProperties.DefaultLobPrefetchSize)
	}
