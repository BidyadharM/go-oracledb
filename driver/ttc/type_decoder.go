...
*/
func DecodeNumberColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeVarcharColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeCharColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
	if columnContext.CharsetForm == 2 {
		switch columnContext.CharsetID {
		case uint16(al16Utf16CharSet):
...
Errors:
  - None.
*/
func DecodeBooleanColumn(_ ColumnContext, data common.B1Array) (driver.Value, error) {
	return data[0] != 0, nil
}
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeBinaryFloatColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeBinaryDoubleColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeIntervalYearToMonthColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeIntervalDayToSecondColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeDateColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
	tm, err := converters.DecodeDate(common.B1Array(data))
	if err != nil {
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeTimestampColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
	tm, err := converters.DecodeTimestamp(common.B1Array(data))
	if err != nil {
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeTimestampWithTimeZoneColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
	tm, err := converters.DecodeTimestampWithTimeZone(common.B1Array(data))
	if err != nil {
...
Errors:
  - Returns a common.OracleError with code common.RowDecodeError via rowDecodeError when the payload
    cannot be decoded.
*/
func DecodeTimestampWithLocalTimeZoneColumn(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
	tm, err := converters.DecodeTimestampWithLocalTimeZone(common.B1Array(data), columnContext.serverTimeZoneOffset)
	if err != nil {
...
Errors:
  - None.
*/
func DecodeClob(columnContext ColumnContext, data common.B1Array) (driver.Value, error) {
...
Errors:
  - None.
*/
func DecodeBlob(_ ColumnContext, data common.B1Array) (driver.Value, error) {
	// LOB columns supply their own charset metadata via LobContext.
	return data, nil
}
...
func rowDecodeError(columnContext ColumnContext, err error, typeName string) error {
	return common.NewOracleError(common.RowDecodeError, err, typeName, columnContext.Name, columnContext.Index)
}
...
- None
*/
func DecodeBinaryColumn(_ ColumnContext, data common.B1Array) (driver.Value, error) {
